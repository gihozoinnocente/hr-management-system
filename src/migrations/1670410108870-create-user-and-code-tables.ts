...
export class createUserAndCodeTables1670410108870
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "code" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "userId" integer, CONSTRAINT "REL_76c04a353b3639752b096e75ec" UNIQUE ("userId"), CONSTRAINT "PK_367e70f79a9106b8e802e1a9825" PRIMARY KEY ("id"))`,
    );
    // await queryRunner.query(
